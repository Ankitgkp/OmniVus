    ...
    <footer className="bg-[#0a2236] text-blue-100 pt-20 pb-8 px-4">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
            ...
            <div className="flex flex-col md:items-center">
                ...
                <div className="grid grid-cols-2 gap-x-8 gap-y-2 text-blue-100/90 text-m">
                    <div>
            ...
            <div>
                ...
                <div className="mb-2 text-xl">Monday - Friday: 7:00 - 17:00</div>
                <div className="mb-2 text-xl">Saturday: 7:00 - 12:00</div>
                <div className="mb-2 text-xl">Sunday and holidays: 8:00 - 10:00</div>
                <div className="mt-4 mb-2 text-base">
                    <span className="font-bold text-white">For more then 30 years,</span> IT Service has been a reliable partner in the field of logistics and cargo forwarding.
                </div>
